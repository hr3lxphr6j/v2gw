...
V2GW_INIT_V2RAY_VERSION=${V2GW_INIT_V2RAY_VERSION:-latest}
# xray
V2GW_INIT_WITH_XRAY=${V2GW_INIT_WITH_XRAY:-1}
V2GW_INIT_XRAY_VERSION=${V2GW_INIT_XRAY_VERSION:-latest}
# v2ray-exporeter
V2GW_INIT_WITH_V2RAY_EXPORTER=${V2GW_INIT_WITH_V2RAY_EXPORTER:-1}
V2GW_INIT_V2RAY_EXPORTER_VERSION=${V2GW_INIT_V2RAY_EXPORTER_VERSION:-latest}
